...
public class Test {
    ...
    // Client c = new Client("Kouame", "Samya", new Date(), ss.findById(2));
    //  cs.create(c);
      //Client c1 = new Client("Maras", "Zineb", new Date(), ss.findById(2));
      //cs.create(c1);
       //Client c2 = new Client("Maarouf", "Sara", new Date(), ss.findById(3));
      //cs.create(c2);
      //Client c3 = new Client("Alaoui", "Ali", new Date(), ss.findById(3));
    // cs.create(c3);
    //  Client c4 = new Client("Rami", "saad", new Date(), ss.findById(3));
    //  cs.create(c4);
